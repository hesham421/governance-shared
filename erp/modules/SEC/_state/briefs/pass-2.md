...
- `governance-shared/erp/modules/SEC/P3_2/flow-diagram-sec.md`
- `governance-shared/erp/modules/SEC/P3_2/ui-ux-spec-sec.md`
- `governance-shared/erp/modules/SEC/P3_2/frontend-execution-plan-sec.md`
- `governance-shared/erp/modules/SEC/P3_2/registry-exec-fe-sec.md` (registry)
...
Before writing any phase, bind this plan to `_inputs/api-docs-sec.md`. Record only
what exists in neither source alone — the shapes stay where they are published:
```
API SURFACE — SEC v1   (shapes: api-docs-sec.md — cited by API-* id, never restated)
BINDING     REQ-SEC-<seq> → API-SEC-<seq> — the binding only; verb, path, request/response
...
CODES       runtime error code → RULE-SEC-<seq> — the link neither the api-docs nor the SRS carries
```
...
|---|---|---|---|---|
| 1 | `F1` | F1 — Models & Types | always — one SUB per screen | yes — `SUB:F1-SCR-SEC-<seq>` |
| 2 | `F2` | F2 — Data Hooks | always — one SUB per screen | yes — `SUB:F2-SCR-SEC-<seq>` |
| 3 | `F3` | F3 — Forms & Validators | always — one SUB per screen | yes — `SUB:F3-SCR-SEC-<seq>` |
| 4 | `F4` | F4 — Screens & Routes | always — one SUB per screen | yes — `SUB:F4-SCR-SEC-<seq>` |
...
**RF1 — Models & types.**
Field/DTO binding : see _inputs/api-docs-sec.md — the published request/response
...
- Per-screen SUB: `<!-- SUB:F1-SCR-SEC-<seq>:START traces=… -->` for **every** `SCR-*`.
...
- Per-screen SUB: `<!-- SUB:F2-SCR-SEC-<seq>:START traces=… -->` for **every** `SCR-*`.
...
- Per-screen SUB: `<!-- SUB:F3-SCR-SEC-<seq>:START traces=… -->` for **every** `SCR-*`.
...
- Per-screen SUB: `<!-- SUB:F4-SCR-SEC-<seq>:START traces=… -->` for **every** `SCR-*`.
...
DECISIONS     refs-exist      every ADR this plan cites exists on disk in erp/decisions/SEC/
...
<!-- GENERATED by `gov.py fetch-inputs` — do not edit.
     source : /Users/ezzat/my project/factory/governance-shared/erp/modules/SEC/api-docs
     files  : 11
     digest : 099c5223fcb33a207fa87780cec9b3f20310bc736513550e88fb6d555380745b
...
<!-- fetched-from: endpoints/active-sessions.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Active Sessions
...
<!-- fetched-from: endpoints/audit-log.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Audit Log
...
<!-- fetched-from: endpoints/authentication.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Authentication
...
<!-- fetched-from: endpoints/menu.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Menu
...
<!-- fetched-from: endpoints/module-registry.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Module Registry
...
<!-- fetched-from: endpoints/role-grants.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Role Grants
...
<!-- fetched-from: endpoints/roles.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Roles
...
<!-- fetched-from: endpoints/security-dashboard.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Security Dashboard
...
<!-- fetched-from: endpoints/sign-up-requests.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Sign-up Requests
...
<!-- fetched-from: endpoints/users.md -->
<!-- AUTO-GENERATED by api-doc-generator — do not edit manually -->
# Users
